...
const Errors = require("../api/errors/todo-wokrshop-error.js");
...
const logger = LoggerFactory.get("TodoWokrshopAbl");

class TodoWokrshopAbl {
  constructor() {
    this.validator = Validator.load();
    this.dao = DaoFactory.getDao("todoWokrshop");
  }
  ...
  // async checkInstance(awid, notExistError) {
  //   const listInstance = await this.dao.getByAwid(awid);
  //   if (!listInstance) {
...
module.exports = new TodoWokrshopAbl();
